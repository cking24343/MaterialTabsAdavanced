...
public class MaterialTab<T extends TextView> implements View.OnTouchListener {
    ...
    private final RevealColorView background;
    ...
    public MaterialTab(Context ctx, tabBuilder cho) {
        ...
        final tabBuilder h = cho;
        hasIcon = h.hasIcon();
        completeView = h.wholeTab() != null ? h.wholeTab() : null;
        icon = h.getIcon() != null ? h.getIcon() : null;
        text = h.getTextView() != null ? (T) h.getTextView() : null;
        background = h.getBg() != null ? h.getBg() : null;
